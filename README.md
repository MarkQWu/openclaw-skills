...
> 帮我更新爆款剧本工坊 skill：从 https://github.com/MarkQWu/openclaw-skills 拉取最新版的 short-drama 目录，覆盖到我的 skills 目录下。必须从 GitHub 重新拉取，不要用本地缓存
...
最新版本：**v1.4**（2026-03-31）— 分镜全能多参 + 安装镜像降级
