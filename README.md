...
**当前版本：v1.31.0**（2026-05-07）· 版本历史见 [GitHub Releases](https://github.com/MarkQWu/openclaw-skills/releases) · 小白看 [使用说明](short-drama/使用说明.md)
...
cp -r openclaw-skills/short-drama-remake ~/.claude/skills/short-drama-remake
```
